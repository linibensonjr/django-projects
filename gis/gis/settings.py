...
SECRET_KEY = 'django-insecure-4s$k9gz4e(7-+za*5s+ngdpze)3yj)r#dbqzn+$6mo@ul6!n2m'
...
os.environ['PATH'] = r"C:\Program Files\GDAL" +";" + os.environ['PATH']

GDAL_LIBRARY_PATH = r'C:\Program Files\GDAL\gdal204.dll'
